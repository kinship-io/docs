...
### 8. Download the Add-in
The next page provides a direct link to download the Kinship Add-in. Follow the instructions to install it and connect to your account.
